...
{
    String[] LosingMessage = new String[] {"Y","O","U"," ","L","O","S","E"};
    for (int c = 6; c < 14; c++)
        buttons[9][c].setLabel(LosingMessage[c-6]);
}
public void displayWinningMessage()
{
    String[] WinningMessage = new String[] {"Y","O","U"," ","W","I","N","!"};
    for (int c = 6; c < 14; c++)
        buttons[9][c].setLabel(WinningMessage[c-6]);
}
